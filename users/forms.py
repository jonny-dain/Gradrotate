...
class StudentForm(ModelForm):
    ...
    class Meta:
        model = Intern
        fields = '__all__'
        exclude = ['user','email','progress','allocated_job','computing_skills','computing_skills','analytic_skills','marketing_skills','management_skills','leadership_skills','business_skills','admin_skills','job_location','remote','first_preference', 'second_preference', 'third_preference']
...
class StudentForm2(ModelForm):
    ...
    class Meta:
        model = Intern
        fields = '__all__'
        exclude = ['user','name','allocated_job','computing_skills','analytic_skills','marketing_skills','management_skills','leadership_skills','business_skills','admin_skills','email','progress','first_preference', 'second_preference', 'third_preference']
...
class StudentForm3(ModelForm):
    class Meta:
        model = Intern
        fields = '__all__'
        exclude = ['user','allocated_job','name','email','progress','job_location','remote','first_preference', 'second_preference', 'third_preference']
...
#name, manager name, job name, job description, day in the life
    class Meta:
        model = Job
        fields = '__all__'
        exclude = ['user','manager','name','allocated_intern','description','team','daily_tasks','computing_skills','remote','wage','analytic_skills','marketing_skills','management_skills','leadership_skills','business_skills','admin_skills','progress','job_location','email']
...
#location, remote balance, pay
    ...
    class Meta:
        model = Job
        fields = '__all__'
        exclude = ['user','manager','computing_skills','allocated_intern','team','wage','analytic_skills','marketing_skills','job_location','remote','wage','management_skills','leadership_skills','business_skills','admin_skills','progress','manager_name','email']
...
#skills
    class Meta:
        model = Job
        fields = '__all__'
        exclude = ['user','manager','remote','allocated_intern','progress','team','wage','name','daily_tasks','manager_name','job_location','description','email']
...
#location, remote balance, pay
    ...
    class Meta:
        model = Job
        fields = '__all__'
        exclude = ['user','manager','allocated_intern','computing_skills','wage','name','daily_tasks','description','analytic_skills','marketing_skills','management_skills','leadership_skills','business_skills','admin_skills','progress','manager_name','email']
